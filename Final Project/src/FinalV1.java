...
public class FinalV1 {
	...
	public static void main(String[] args) {
		...
		while (game.on && game.currentTurn <= 9) {
...
class TicTacToe {
	...
	// still has a bug in this method
	
	public void hasWon(String str) {
		...
		if (array[0].equals(str) && array[1].equals(str) && array[2].equals(str)) {
			System.out.printf("The %s player has won!\n", player);
			exit();
		} else if (array[3].equals(str) && array[4].equals(str) && array[5].equals(str)) {
			System.out.printf("The %s player has won!\n", player);
			exit();
		} else if (array[6].equals(str) && array[7].equals(str) && array[8].equals(str)) {
			System.out.printf("The %s player has won!\n", player);
			exit();
		} else if (array[0].equals(str) && array[3].equals(str) && array[6].equals(str)) {
			System.out.printf("The %s player has won!\n", player);
			exit();
		} else if (array[1].equals(str) && array[4].equals(str) && array[7].equals(str)) {
			System.out.printf("The %s player has won!\n", player);
			exit();
		} else if (array[2].equals(str) && array[5].equals(str) && array[8].equals(str)) {
			System.out.printf("The %s player has won!\n", player);
			exit();
		} else if (array[0].equals(str) && array[4].equals(str) && array[8].equals(str)) {
			System.out.printf("The %s player has won!\n", player);
			exit();
		} else if (array[2].equals(str) && array[4].equals(str) && array[6].equals(str)) {
			System.out.printf("The %s player has won!\n", player);
			exit();
		}
